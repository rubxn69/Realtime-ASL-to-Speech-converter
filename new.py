...
alphabet_delay = 1  # One second delay for alphabet
word_delay = 3  # Four second delay for word prediction
predicted_word = ""
...
while True:
    ...
    # Check if 4 seconds have passed since the last alphabet prediction
